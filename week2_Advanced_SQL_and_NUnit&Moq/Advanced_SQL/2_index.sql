...
-- MySQL does not support explicit clustered indexes.
-- Goal: Create an index on the OrderDate column in the Orders table and compare query execution time before and after index creation.

-- Step 1: Query to fetch orders before index creation
SELECT * FROM Orders WHERE OrderDate = '2023-01-15';

-- Step 2: Create an index on OrderDate
